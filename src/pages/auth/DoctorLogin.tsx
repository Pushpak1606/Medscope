  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold font-heading text-foreground tracking-tight sm:text-3xl">Doctor portal login</h1>
          <p className="mt-2 text-sm text-muted-foreground">Sign in to manage patients, schedules, AI-assisted medicine guidance, and consultation workflows.</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <Button type="submit" size="lg" className="w-full rounded-xl">Login as Doctor</Button>
        </form>
        ...
        <div className="text-center text-sm text-muted-foreground space-y-1">
          <p>New doctor here? <Link to="/doctor/signup" className="font-medium text-primary hover:underline">Sign up</Link></p>
          <p>Are you a patient? <Link to="/patient/login" className="font-medium text-primary hover:underline">Patient Login</Link></p>
        </div>
      </div>
    </AuthLayout>
  );
