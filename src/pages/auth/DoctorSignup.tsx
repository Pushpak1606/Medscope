        ...
        >
          ...
          <div className="space-y-4 bg-card/50 backdrop-blur-md p-6 rounded-2xl border border-border/50">
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
              Your professional information is fully protected. We use this data only to personalize your clinical dashboard and configure your AI-assisted workflows.
            </p>
          </div>
          <div className="mt-8 flex items-center justify-center gap-3 text-sm text-violet-500 font-bold bg-violet-500/10 px-6 py-3 rounded-full">
            <Loader2 className="h-5 w-5 animate-spin" /> Preparing your setup...
          </div>
        </motion.div>
      </div>
    );
  ...
  return (
    ...
    >
      <div className="space-y-7">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                ...
                <Input id="name" value={formData.name} onChange={handleChange} placeholder="Dr. Jane Smith" className="pl-11 h-12 bg-card border-border/80 hover:bg-background focus-visible:bg-background focus-visible:ring-violet-500/20 focus-visible:border-violet-500 transition-all rounded-xl" />
              </div>
            </div>
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                ...
                <Input id="email" type="email" value={formData.email} onChange={handleChange} placeholder="doctor@hospital.com" className="pl-11 h-12 bg-card border-border/80 hover:bg-background focus-visible:bg-background focus-visible:ring-violet-500/20 focus-visible:border-violet-500 transition-all rounded-xl" />
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                ...
                <Input id="phone" type="tel" value={formData.phone} onChange={handleChange} placeholder="+91 98765 43210" className="pl-11 h-12 bg-card border-border/80 hover:bg-background focus-visible:bg-background focus-visible:ring-violet-500/20 focus-visible:border-violet-500 transition-all rounded-xl" />
              </div>
            </div>
            <div className="space-y-2.5">
              <Label htmlFor="specialization" className="text-sm font-semibold text-foreground/80">Specialization</Label>
              <Input id="specialization" value={formData.specialization} onChange={handleChange} placeholder="e.g. Cardiology" className="h-12 bg-card border-border/80 hover:bg-background focus-visible:bg-background focus-visible:ring-violet-500/20 focus-visible:border-violet-500 transition-all rounded-xl" />
            </div>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                ...
                <Input id="password" type={showPassword ? "text" : "password"} value={formData.password} onChange={handleChange} placeholder="••••••••" className="pl-11 pr-11 h-12 bg-card border-border/80 hover:bg-background focus-visible:bg-background focus-visible:ring-violet-500/20 focus-visible:border-violet-500 transition-all rounded-xl" />
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                <Lock className="absolute left-3.5 top-1/2 h-5 w-5 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-violet-500" />
                <Input id="confirmPassword" type={showConfirm ? "text" : "password"} value={formData.confirmPassword} onChange={handleChange} placeholder="••••••••" className="pl-11 pr-11 h-12 bg-card border-border/80 hover:bg-background focus-visible:bg-background focus-visible:ring-violet-500/20 focus-visible:border-violet-500 transition-all rounded-xl" />
        ...
        <Button onClick={handleGoogleSignup} variant="outline" size="lg" className="w-full h-12 rounded-xl bg-card border-border/80 hover:bg-muted text-foreground font-semibold transition-colors">
