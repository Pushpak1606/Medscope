...
const ProfileSnapshotWidget = ({ profile }: ProfileSnapshotWidgetProps) => {
  return (
    <div className="flex flex-col rounded-[2.5rem] bg-card/80 backdrop-blur-xl border border-border/50 shadow-sm p-6 sm:p-8 relative overflow-hidden h-full">
      {/* Background Glow */}
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-primary/20 blur-[50px] rounded-full pointer-events-none"></div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        <div className="p-3 rounded-2xl bg-background/50 border border-border/50 text-center">
      ...
      <div className="mt-auto">
        <Button asChild variant="outline" className="w-full rounded-xl bg-background hover:bg-muted border-border/50 shadow-sm font-semibold h-12">
